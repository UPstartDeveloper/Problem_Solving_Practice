class Array:
    ...
    def bubble_sort(self):
        ...
        while swaps != 0:
            ...
            while index < len(self.arr) - 1:
                ...
                elem, elem_after = self.arr[index], self.arr[index + 1]
                if elem_after < elem:
                    self.arr[index], self.arr[index + 1] = (elem_after, elem)
    ...
    def merge_sort(self, array=None):
        ...
        def merge(sorted_left, sorted_right):
            ...
            sorted_array = list()
            while ndx_left < len(sorted_left) and ndx_right < len(sorted_right):
                elem_left, elem_right = (sorted_left[ndx_left], sorted_right[ndx_right])
