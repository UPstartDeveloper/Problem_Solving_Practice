    ...
    def isValidBST(self, root: Optional[TreeNode]) -> bool:
        ...
        def _postorder_recursive(node):
            if node:
                ...
                if node.left:
                    smallest_largest_left = _postorder_recursive(
                        node.left
                    )
                
                # visit right subtree
                if node.right:
                    smallest_largest_right = _postorder_recursive(
                        node.right
                    )
                else:
                ...
                if smallest_largest_left and smallest_largest_right:
                    if (
                        smallest_largest_left[1] < node.val and 
                        node.val < smallest_largest_right[0]
                    ):
                        return (
                            smallest_largest_left[0], 
