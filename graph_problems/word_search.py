            ...
            if word_letter == board_letter:
                ...
                # push the neighbors
                    ...
                    for direction in self.DIRECTIONS:
                        ...
                        if 0 <= next_row < len(board) and 0 <= next_col < len(
                            board[next_row]
                        ):
                            ...
                            if board[next_row][next_col] == word[word_index + 1]:
                                ...
                                check_letter_mutative(
                                    next_row, next_col, word_index + 1
                                )
                ...
                # push the neighbors
                    ...
                    for direction in self.DIRECTIONS:
                        ...
                        if 0 <= next_row < len(board) and 0 <= next_col < len(
                            ...
                            if (next_row, next_col) not in self.visited and board[
                                next_row
                            ][next_col] == word[word_index + 1]:
                                # traverse the next node
                                check_letter_immutative(
                                    next_row, next_col, word_index + 1
                                )
                                # in case that route didn't help, remove
                                self.visited.remove((next_row, next_col))
